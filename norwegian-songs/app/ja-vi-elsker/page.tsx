    ...
    <main className="main-container">
      ...
      <div className="lyrics">
        <p>
          ...
          elsker det og tenker <br /> På vår far og mor <br /> Og den saganatt
          som senker <br /> Drømmer på vår jord
        </p>
        ...
        <p>
          ...
          Mødrene har grett
          <br /> Har den herre stille lempet Så vi vant vår rett
        </p>
        ...
        <p>
          ...
          <br /> Også vi når det blir krevet
